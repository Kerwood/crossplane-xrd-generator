module github.com/kerwood/crossplane-xrd-generator/cmd-example
...
require (
	github.com/kerwood/crossplane-xrd-generator/generator v1.0.2
	...
	github.com/kerwood/crossplane-xrd-generator/resources/xexample v1.0.0
)
